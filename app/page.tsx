  ...
  return (
    <div className="relative min-h-screen bg-white pt-20">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden py-12 lg:py-0">
        <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10">
          <div className="order-2 lg:order-1">
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-gray-900 leading-tight mb-6 animate-in fade-in slide-in-from-bottom duration-1000">
              Elevate Your <br />
              <span className="text-gold-500">Everyday</span> Style
            </h1>
            <p className="text-lg text-gray-600 mb-8 max-w-lg animate-in fade-in slide-in-from-bottom duration-1000 delay-200">
              Discover the finest Egyptian cotton T-shirts, meticulously crafted for comfort and sophistication. Experience the touch of luxury.
            </p>
        ...
        <div className="absolute right-0 top-1/2 -translate-y-1/2 select-none pointer-events-none opacity-[0.03] text-[20vw] font-serif font-bold whitespace-nowrap rotate-90 translate-x-1/2">
          DRESSCO
        </div>
      </section>
      ...
      <section className="py-2 mb-12">
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-6 leading-none">
          {/* Women's Card */}
          <div className="relative aspect-4/5 md:aspect-auto md:h-[80vh] overflow-hidden group">
            ...
            <div className="absolute bottom-12 left-8 md:left-12 right-8 text-white z-10">
              <span className="block text-[10px] md:text-xs font-semibold tracking-[0.3em] uppercase mb-4 opacity-90">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif mb-8 leading-tight uppercase font-bold tracking-wider">
                Sustainably Made In <br /> Sri Lanka
              </h2>
              <Link
                href="/women"
                className="inline-block bg-white text-gray-900 border border-transparent px-8 md:px-12 py-4 text-xs font-bold tracking-[0.2em] uppercase hover:bg-gold-500 hover:text-white transition-all"
              >
                Shop Women
              </Link>
            </div>
          ...
          <div className="relative aspect-4/5 md:aspect-auto md:h-[80vh] overflow-hidden group">
            ...
            <div className="absolute bottom-12 left-8 md:left-12 right-8 text-white z-10">
              <span className="block text-[10px] md:text-xs font-semibold tracking-[0.3em] uppercase mb-4 opacity-90">
                100% Organic Cotton T-shirts for Men
              </span>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif mb-8 leading-tight uppercase font-bold tracking-wider">
                Expertly Crafted In <br /> Sri Lanka
              </h2>
              <Link
                href="/men"
                className="inline-block bg-white text-gray-900 border border-transparent px-8 md:px-12 py-4 text-xs font-bold tracking-[0.2em] uppercase hover:bg-gold-500 hover:text-white transition-all"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[1440px] mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <div className="flex justify-center gap-12 border-b border-gray-100 pb-px">
              <button className="text-sm font-bold tracking-[0.2em] uppercase py-4 border-b-2 border-gray-900 transition-all">
                For Women
              </button>
              <button className="text-sm font-bold tracking-[0.2em] uppercase py-4 text-gray-400 hover:text-gray-900 transition-all">
                For Men
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 leading-relaxed mb-4 italic">
                  "I own 13 tees from the classic t-shirt company and they are by far the best t-shirts I've ever owned! They are so soft and hold th..."
                </p>
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <h3 className="font-serif text-lg mb-2 text-gray-900">I love the t-shirt, runs</h3>
                <p className="text-sm text-gray-500 leading-relaxed mb-4 italic">
                  "I love the t-shirt, runs a little small and I had to exchange it for a larger size. No problem exchanging it, prompt and efficient cu..."
                </p>
                <button className="text-xs font-bold underline mb-4 block hover:text-gold-500">Read More</button>
      ...
      <section className="relative h-[60vh] md:h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
          ...
          <p className="text-lg md:text-2xl font-light leading-relaxed mb-12 opacity-90">
            ...
            Organic Cotton T-shirts, meticulously crafted for the conscious individual who
