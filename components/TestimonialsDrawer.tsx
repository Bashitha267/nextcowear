...
const TestimonialsDrawer = () => {
    ...
    return (
        <>
            ...
            <div className={`absolute fixed left-0 top-24 translate-y-3 z-40 transition-transform duration-300 ${isOpen ? 'translate-x-[500px] lg:translate-x-[600px]' : 'translate-x-0'}`}>
                <button
